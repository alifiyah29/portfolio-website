...
const RecentWork: React.FC = () => {
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4 text-[#FFB300]">Recent Work</h2>
      <div className="bg-[#1F1F1F] p-4 rounded-lg">
        ...
        <p className="text-[#4eabda] mb-2">Under Prof. Tamuchin McCreless (Sep &apos;24 – Present)</p>
        <ul className="list-disc text-[#E0E0E0] space-y-2">
